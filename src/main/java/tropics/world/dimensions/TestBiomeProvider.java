...
public class TestBiomeProvider extends BiomeProvider {
    ...
    public static final Codec<TestBiomeProvider> CODEC = RegistryLookupCodec.create(Registry.BIOME_REGISTRY)
            .xmap(TestBiomeProvider::new, TestBiomeProvider::getBiomeRegistry).codec();
