...
public class TestChunkGenerator extends ChunkGenerator {
    ...
    public static final Codec<TestChunkGenerator> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    RegistryLookupCodec.create(Registry.BIOME_REGISTRY).forGetter(TestChunkGenerator::getBiomeRegistry),
                    SETTINGS_CODEC.fieldOf("settings").forGetter(TestChunkGenerator::getTutorialSettings)
    ...
    public TestChunkGenerator(Registry<Biome> registry, Settings settings) {
        ...
        Tropics.LOGGER.info("Chunk generator settings: " + settings.getBaseHeight() + ", " + settings.getHorizontalVariance() + ", " + settings.getVerticalVariance());
    }
    ...
    public Registry<Biome> getBiomeRegistry() {
        return ((TestBiomeProvider)biomeSource).getBiomeRegistry();
    }
    ...
    public ChunkGenerator withSeed(long seed) {
        return new TestChunkGenerator(getBiomeRegistry(), settings);
    }
