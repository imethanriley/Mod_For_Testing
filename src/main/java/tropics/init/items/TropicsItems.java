...
public class TropicsItems {
	//Items
	public static Item dimensionOpener;
	...
	public static void RegisterItems(final RegistryEvent.Register<Item> event)
	{
		...
		(
			//Items
			dimensionOpener = new DimensionOpenerItem().setRegistryName("dimension_opener"),
			
			volcanic_ingot = new Item(new Item.Properties().group(Tropics.TROPICS)).setRegistryName(Tropics.location("volcanic_ingot")),
			dominus_ingot = new Item(new Item.Properties().group(Tropics.TROPICS)).setRegistryName(Tropics.location("dominus_ingot")),

			//Block Items
			dominus_ore = new BlockItem(TropicsBlocks.dominus_ore, new Item.Properties().group(Tropics.TROPICS)).setRegistryName(TropicsBlocks.dominus_ore.getRegistryName()),
			volcanic_block = new BlockItem(TropicsBlocks.volcanic_block, new Item.Properties().group(Tropics.TROPICS)).setRegistryName(TropicsBlocks.volcanic_block.getRegistryName()),
			
			//Tools
			volcanic_axe = new AxeItem(TropicsToolMaterials.volcanic, +7f, -3f, new Item.Properties().group(Tropics.TROPICS)).setRegistryName(Tropics.location("volcanic_axe")),
			volcanic_hoe = new HoeItem(TropicsToolMaterials.volcanic, -1, 0f, new Item.Properties().group(Tropics.TROPICS)).setRegistryName(Tropics.location("volcanic_hoe")),
			volcanic_pickaxe = new PickaxeItem(TropicsToolMaterials.volcanic, +3, -2.8f, new Item.Properties().group(Tropics.TROPICS)).setRegistryName(Tropics.location("volcanic_pickaxe")),
		...
		//Spawn Eggs
		angler_fish_spawn_egg = new SpawnEggItem(TropicsEntities.ANGLER_FISH, 0xFFFFFF, 0x000FFF, (new Item.Properties()).group(Tropics.TROPICS)).setRegistryName(Tropics.location("angler_fish_spawn_egg"));
		reg.register(TropicsItems.angler_fish_spawn_egg);
		
		raven_spawn_egg = new SpawnEggItem(TropicsEntities.RAVEN, 0xFFFFFF, 0x000FFF, (new Item.Properties()).group(Tropics.TROPICS)).setRegistryName(Tropics.location("raven_spawn_egg"));
		reg.register(TropicsItems.raven_spawn_egg);
		
		vulcan_spawn_egg = new SpawnEggItem(TropicsEntities.VULCAN, 0xFFFFFF, 0x000FFF, (new Item.Properties()).group(Tropics.TROPICS)).setRegistryName(Tropics.location("vulcan_spawn_egg"));
		reg.register(TropicsItems.vulcan_spawn_egg);
		
		poison_dart_frog_spawn_egg = new SpawnEggItem(TropicsEntities.POISON_DART_FROG, 0xFFFFFF, 0x000FFF, (new Item.Properties()).group(Tropics.TROPICS)).setRegistryName(Tropics.location("poison_dart_frog_spawn_egg"));
